...
```{r echo=FALSE, Exploring_Most_Money_2_1}
...
```{r echo=FALSE, Exploring_Most_Money_5_1}
...
```{r echo=FALSE, Exploring_Most_Money_5_3}
...
```{r echo=FALSE, Exploring_Cities_8}

# taking out one batch of the duplicate 'city' rows
set_1 <- subset(total_contribs, duplicated(total_contribs$contbr_city))
#set_1
# getting both instances
set_both <- subset(total_contribs, total_contribs$contbr_city %in% set_1$contbr_city)
#set_both
# creating the complementary set to 'set_1'
set_2 <- subset(set_both, !set_both$POPESTIMATE2012 %in% set_1$POPESTIMATE2012)
#set_2
### TODO: make this work :)
lower_df <- subset(set_both, set_1$contbr_city == set_2$contbr_city & set_1$POPESTIMATE2012 < set_1$POPESTIMATE2012)
...
```{r echo=FALSE, Exploring_Unemployment_4}
...
```{r echo=FALSE, Exploring_Unemployment_5}
